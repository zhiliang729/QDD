...
class UserService {
    ...
    //MARK: - 1. 获取用户信息
    @discardableResult
    class func user(id: Int, success: ((User) -> Void)?, fail: ((RequestError) -> Void)? ) -> DataRequest {
    ...
    //MARK: - 2. 获取用户评论
    @discardableResult
    class func comments(id: Int, start: Int, success: ((UserCommentsHandler) -> Void)?, fail: ((RequestError) -> Void)? ) -> DataRequest {
    ...
    //MARK: - 3. 获取用户收藏的文章
    @discardableResult
    class func topics(id: Int, start: Int, success: ((UserTopicsHandler) -> Void)?, fail: ((RequestError) -> Void)? ) -> DataRequest {
    ...
    //MARK: - 4. 获取用户订阅的收藏夹
    @discardableResult
    class func subNodes(id: Int, start: Int, success: ((UserNodesHandler) -> Void)?, fail: ((RequestError) -> Void)? ) -> DataRequest {
    ...
    //MARK: - 5. 获取用户创建的收藏夹
    @discardableResult
    class func nodes(id: Int, success: ((UserNodesHandler) -> Void)?, fail: ((RequestError) -> Void)? ) -> DataRequest {
