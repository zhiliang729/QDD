...
final class FocusViewController: BaseViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        G.logger.debug("duration: \(duration)")
    }
    
    //MARK: - button actions
    func startWork(sender: UIButton?) {
        G.logger.debug("startWork")
...
//        G.logger.debug(applicationContext)
